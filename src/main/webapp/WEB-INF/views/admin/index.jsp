...
<!-- Mirrored from flixtv.volkovdesign.com/admin/index.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jun 2024 14:22:56 GMT -->
<head>
	<meta charset="utf-8">
	...
	<div class="sidebar">
		...
		<ul class="sidebar__nav">
			<li class="sidebar__nav-item">
				<a href="home" class="sidebar__nav-link sidebar__nav-link--active"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20,8h0L14,2.74a3,3,0,0,0-4,0L4,8a3,3,0,0,0-1,2.26V19a3,3,0,0,0,3,3H18a3,3,0,0,0,3-3V10.25A3,3,0,0,0,20,8ZM14,20H10V15a1,1,0,0,1,1-1h2a1,1,0,0,1,1,1Zm5-1a1,1,0,0,1-1,1H16V15a3,3,0,0,0-3-3H11a3,3,0,0,0-3,3v5H6a1,1,0,0,1-1-1V10.25a1,1,0,0,1,.34-.75l6-5.25a1,1,0,0,1,1.32,0l6,5.25a1,1,0,0,1,.34.75Z"/></svg> <span>Dashboard</span></a>
			</li>

			<li class="sidebar__nav-item">
				<a href="admin/list" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10,13H3a1,1,0,0,0-1,1v7a1,1,0,0,0,1,1h7a1,1,0,0,0,1-1V14A1,1,0,0,0,10,13ZM9,20H4V15H9ZM21,2H14a1,1,0,0,0-1,1v7a1,1,0,0,0,1,1h7a1,1,0,0,0,1-1V3A1,1,0,0,0,21,2ZM20,9H15V4h5Zm1,4H14a1,1,0,0,0-1,1v7a1,1,0,0,0,1,1h7a1,1,0,0,0,1-1V14A1,1,0,0,0,21,13Zm-1,7H15V15h5ZM10,2H3A1,1,0,0,0,2,3v7a1,1,0,0,0,1,1h7a1,1,0,0,0,1-1V3A1,1,0,0,0,10,2ZM9,9H4V4H9Z"/></svg> <span>Series</span></a>
			</li>
			...
			<div class="row">
				...
				<div class="col-12">
					<div class="main__title">
						...
						<a href="admin/create" class="main__title-link">add item</a>
					</div>
				</div>
				<!-- end main title -->
...
<!-- Mirrored from flixtv.volkovdesign.com/admin/index.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jun 2024 14:23:02 GMT -->
</html>